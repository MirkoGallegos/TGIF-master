var data = {
 ...
 var statistics = [{
     ...
     "voteWithPartyDemocrats": 0,
     "voteWithPartyRepublicans": 0,
     "voteWithPartyIndependents": 0,
     "leastEngagedNames": 0,
 ...
 var tablaA = "<thead class='thead'><tr><th class='text-center align-top'>Party</th><th class='text-center align-top'>Num. of Reps</th><th class='text-center align-top'>% Voted with Party</th></thead>";
 var tablaB = "<thead class='thead'><tr><th class='text-center align-top'>Name</th><th class='text-center align-top'>Num. of Missed Votes</th><th class='text-center align-top'>% Missed</th></thead>";
 var tablaC = "<thead class='thead'><tr><th class='text-center align-top'>Name</th><th class='text-center align-top'>Num. of Missed Votes</th><th class='text-center align-top'>% Missed</th></thead>";
 var tablaD = "<thead class='thead'><tr><th class='text-center align-top'>Name</th><th class='text-center align-top'>Num. of Party Votes</th><th class='text-center align-top'>% Party Votes</th></thead>";
 var tablaE = "<thead class='thead'><tr><th class='text-center align-top'>Name</th><th class='text-center align-top'>Num. of Party Votes</th><th class='text-center align-top'>% Party Votes</th></thead>";
 var str = JSON.stringify(data, null, 2);
 var valor = JSON.parse(str);
 var dibujoA = document.getElementById("senateAtAGlance");
 var dibujoB = document.getElementById("senateLeastEngaged");
 var dibujoC = document.getElementById("senateMostEngaged");
 var dibujoD = document.getElementById("senateLeastLoyal");
 var dibujoE = document.getElementById("senateMostLoyal");
 ...
 var democratMembers = arreglo.filter(filtraD);
 var republicanMembers = arreglo.filter(filtraR);
 var independentMembers = arreglo.filter(filtraI);
 //Estas son las funciones que definen según qué criterio se va a aplicar el filtro
 function filtraD(arreglo) {
     return arreglo.party == "D";
 };
 function filtraR(arreglo) {
     return arreglo.party == "R";
 };
 function filtraI(arreglo) {
     return arreglo.party == "I";
 };
 //Acá le asigno los valores que conseguí con el filtrado, al atributo correspondiente en el json statistics
 statistics.numberOfDemocrats = democratMembers.length;
 statistics.numberOfRepublicans = republicanMembers.length;
 statistics.numberOfIndependents = independentMembers.length;
 function averageVotes(array) {
     var sumarVotos = 0;
     for (let i = 0; i < array.length; i++) {
         sumarVotos += array[i].votes_with_party_pct;
     }
     return (array != null && array != undefined && array.length != 0) ? (sumarVotos / array.length).toFixed(2) : 0;
 }
 //Asigno el valor a los atributos del json para el promedio de votos por partido
 statistics.voteWithPartyDemocrats = averageVotes(democratMembers);
 statistics.voteWithPartyRepublicans = averageVotes(republicanMembers);
 statistics.voteWithPartyIndependents = averageVotes(independentMembers);
 //Función para averiguar los más y menos comprometidos y leales
 //Primero declaro un par de variables necesarias
 let arrayAuxiliarEngaged = arreglo;
 let mostEngaged = [];
 let leastEngaged = [];
 let arrayAuxiliarLoyal = arreglo;
 let mostLoyal = [];
 let leastLoyal = [];
 let PNecesario = (arreglo.length * 0.1);
 ...
 //La función para crear la tabla "at a glance"
 function crearAtAGlance() {
     tablaA += "<tr><td class='text-center'>Democrat</td>"
     tablaA += "<td class='text-center'>" + " " + statistics.numberOfDemocrats + " " + "</td>"
     tablaA += "<td class='text-center'>" + " " + statistics.voteWithPartyDemocrats + " " + " %</td></tr>"
     tablaA += "<tr><td class='text-center'>Republican</td>"
     tablaA += "<td class='text-center'>" + " " + statistics.numberOfRepublicans + " " + "</td>"
     tablaA += "<td class='text-center'>" + " " + statistics.voteWithPartyRepublicans + " " + " %</td></tr>"
     tablaA += "<tr><td class='text-center'>Independent</td>"
     tablaA += "<td class='text-center'>" + " " + statistics.numberOfIndependents + " " + "</td>"
     tablaA += "<td class='text-center'>" + " " + statistics.voteWithPartyIndependents + " " + " %</td></tr>"
     tablaA += "<tr><td class='text-center'>Total</td>"
     tablaA += "<td class='text-center'>" + " " + (statistics.numberOfDemocrats + statistics.numberOfRepublicans + statistics.numberOfIndependents) + " " + "</td>"
     tablaA += "<td class='text-center'>" + " " + (averageVotes(arreglo)) + " " + " %</td></tr>"
 }
 //Crear la tabla "least Engaged"
 function crearLeastEngaged(array) {
     for (let i = 0; i < array.length; i++) {
         tablaB += "<tr>"
         ...
         if (array[i].last_name != null && array[i].first_name != null && array[i].middle_name != null) {
             tablaB += "<td><a href='" + array[i].url + "'>" + array[i].last_name + " " + array[i].first_name + " " + array[i].middle_name + "</a></td>"
         } else if (array[i].middle_name == null) {
             tablaB += "<td><a href='" + array[i].url + "'>" + array[i].last_name + " " + array[i].first_name + " " + "</a></td>"
         }
         tablaB += "<td class='text-center'>" + " " + array[i].missed_votes + " " + "</td>"
         tablaB += "<td class='text-center'>" + " " + array[i].missed_votes_pct + "%" + " " + "</td></tr>"
     }
 }
 function crearMostEngaged(array) {
     for (let i = 0; i < array.length; i++) {
         tablaC += "<tr>"
         //   console.log(array[i].last_name+array[i].first_name+array[i].middle_name)
         if (array[i].last_name != null && array[i].first_name != null && array[i].middle_name != null) {
             tablaC += "<td><a href='" + array[i].url + "'>" + array[i].last_name + " " + array[i].first_name + " " + array[i].middle_name + "</a></td>"
         } else if (array[i].middle_name == null) {
             tablaC += "<td><a href='" + array[i].url + "'>" + array[i].last_name + " " + array[i].first_name + " " + "</a></td>"
         }
         tablaC += "<td class='text-center'>" + " " + array[i].missed_votes + " " + "</td>"
         tablaC += "<td class='text-center'>" + " " + array[i].missed_votes_pct + "%" + " " + "</td></tr>"
     }
 }
 function crearLeastLoyal(array) {
     for (let i = 0; i < array.length; i++) {
         tablaD += "<tr>"
         //   console.log(array[i].last_name+array[i].first_name+array[i].middle_name)
         if (array[i].last_name != null && array[i].first_name != null && array[i].middle_name != null) {
             tablaD += "<td><a href='" + array[i].url + "'>" + array[i].last_name + " " + array[i].first_name + " " + array[i].middle_name + "</a></td>"
         } else if (array[i].middle_name == null) {
             tablaD += "<td><a href='" + array[i].url + "'>" + array[i].last_name + " " + array[i].first_name + " " + "</a></td>"
         }
         tablaD += "<td class='text-center'>" + " " + array[i].total_votes + " " + "</td>"
         tablaD += "<td class='text-center'>" + " " + array[i].votes_with_party_pct + "%" + " " + "</td></tr>"
     }
 }
 function crearMostLoyal(array) {
     for (let i = 0; i < array.length; i++) {
         tablaE += "<tr>"
         //   console.log(array[i].last_name+array[i].first_name+array[i].middle_name)
         if (array[i].last_name != null && array[i].first_name != null && array[i].middle_name != null) {
             tablaE += "<td><a href='" + array[i].url + "'>" + array[i].last_name + " " + array[i].first_name + " " + array[i].middle_name + "</a></td>"
         } else if (array[i].middle_name == null) {
             tablaE += "<td><a href='" + array[i].url + "'>" + array[i].last_name + " " + array[i].first_name + " " + "</a></td>"
         }
         tablaE += "<td class='text-center'>" + " " + array[i].total_votes + " " + "</td>"
         tablaE += "<td class='text-center'>" + " " + array[i].votes_with_party_pct + "%" + " " + "</td></tr>"
     }
 }
 //Acá se crean y llenan todas las tablas del Senado, de Attendance y Party Loyalty
 crearAtAGlance();
 crearLeastEngaged(leastEngaged);
 crearMostEngaged(mostEngaged);
 crearLeastLoyal(leastLoyal);
 crearMostLoyal(mostLoyal);
 //Esta tabla se dibuja en ambos html (Attendance y Party Loyalty), por eso lo dejo en el js.
 dibujoA.innerHTML = tablaA;
 //Estas tablas las paso como scripts en los html correspondientes para que no me rompa (el código, obvio)
 //dibujoB.innerHTML = tablaB;
 //dibujoC.innerHTML = tablaC;
 //dibujoD.innerHTML = tablaD;
 //dibujoE.innerHTML = tablaE;